...
using AD.Windows.Forms.EditableAdapter;
...
namespace AD.Windows.Forms.EditableAdapter.MetaData
{
    ...
    {
        private static readonly Dictionary<Type, TypeMetaData> _contexts = new Dictionary<Type, TypeMetaData>();
        ...
        private static PropertyDescriptor CreateWrapperObjectPropertyWrapper(TypeMetaData context, PropertyInfo property)
        {
            ...
            Func<object, object> reader = property.CanRead ? new Func<object, object>(actualReader.GetValue) : null;
            Action<object, object> writer = property.CanWrite ? new Action<object, object>(actualWriter.SetValue) : null;
