...
namespace AD.Math.Combinatoric
{
    ...
    public class Variations<T> : ICombinatoricResult<T>
    {
        #region Constructors
        ...
        public class EnumeratorWithRepetition : IEnumerator<IList<T>>
        {
            ...
            public bool MoveNext()
            {
                ...
                if (myListIndexes == null)
                {
                    ...
                    for (int i = 0; i < myParent.ClassK; ++i)
                    {
                        myListIndexes.Add(0);
                    }
                    carry = 0;
                ...
                else
                {
                    for (int i = myListIndexes.Count - 1; i >= 0 && carry > 0; --i)
                    {
                        ...
                        carry = 0;
                        if (myListIndexes[i] >= myParent.NElements)
                        {
                            myListIndexes[i] = 0;
                            carry = 1;
                        }
        ...
        public long Count
        {
            get
            {
                ...
                {
                    return (long)System.Math.Pow(NElements, ClassK);
                }
            }
        }
