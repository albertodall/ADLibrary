...
namespace AD.Math.Combinatoric
{
    ...
    public class Permutations<T> : ICombinatoricResult<T>
    {
        /// <summary>
        ...
        #region ICombinatoricResult Interface
        ...
        private long GetCount()
        {
            ...
            for (int i = 1; i < myLexicographicOrders.Length; ++i)
            {
                numerators.AddRange(PrimeFactors.Factor(i + 1));
                ...
                else
                {
                    ...
                    {
                        divisors.AddRange(PrimeFactors.Factor(f));
                    }
                    runCount = 1;
                }
            }
            ...
            return PrimeFactors.EvaluatePrimeFactors(PrimeFactors.DividePrimeFactors(numerators, divisors));
        }
